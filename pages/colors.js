...
export default function Colors() {
  return (
    <div className={styles.colors}>
      <div style={{ backgroundColor: "var(--taupe-primary)" }}>
        <span>taupe-primary: #e5e0de</span>
      </div>
      <div style={{ backgroundColor: "var(--taupe-tint)" }}>
        <span>taupe-tint: #baadab</span>
      </div>
      ...
      <div style={{ backgroundColor: "var(--blue-tint)" }}>
        <span>blue-tint: #baebfa</span>
      </div>
      ...
      <div style={{ backgroundColor: "var(--green-primary)" }}>
        <span>green-primary: #70db8c</span>
      </div>
      <div style={{ backgroundColor: "var(--green-tint)" }}>
        <span>green-tint: #24a147</span>
      </div>
      ...
      <div style={{ backgroundColor: "var(--cyan-tint)" }}>
        <span>cyan-tint: #0096a6</span>
      </div>
      ...
      <div style={{ backgroundColor: "var(--gray-90)" }}>
        <span>gray-90: #262626</span>
      </div>
      <div style={{ backgroundColor: "var(--gray-80)" }}>
        <span>gray-80: #393939</span>
      </div>
      <div style={{ backgroundColor: "var(--gray-70)" }}>
        <span>gray-70: #525252</span>
      </div>
      <div style={{ backgroundColor: "var(--gray-60)" }}>
        <span>gray-60: #6f6f6f</span>
      </div>
      <div style={{ backgroundColor: "var(--gray-50)" }}>
        <span>gray-50: #8d8d8d</span>
      </div>
      <div style={{ backgroundColor: "var(--gray-40)" }}>
        <span>gray-40: #a8a8a8</span>
      </div>
      <div style={{ backgroundColor: "var(--gray-30)" }}>
        <span>gray-30: #c6c6c6</span>
      </div>
      <div style={{ backgroundColor: "var(--gray-20)" }}>
        <span>gray-20: #e0e0e0</span>
      </div>
      <div style={{ backgroundColor: "var(--gray-10)" }}>
        <span>gray-10: #f4f4f4</span>
      </div>
    </div>
  );
}
