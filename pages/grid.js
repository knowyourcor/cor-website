    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
          ...
          <Row justify={{ xs: "center" }}>
            <Column columns={{ xs: 14, md: 7 }}>
              ...
              <div className={styles.description}>
                A simple React based grid system using flex. Uses 14 columns
        ...
        <Container>
          ...
          <Row className={styles.exampleRow}>
            <Column columns={{ xs: 14, md: 7 }} ordering={{ xs: 2, md: 1 }}>
              <div className={styles.box}>
                <span>xs: second, md: first</span>
              </div>
            </Column>
            <Column columns={{ xs: 14, md: 7 }} ordering={{ xs: 1, md: 2 }}>
              <div className={styles.box}>
